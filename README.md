...
- **⚠️ 손들기 기능을 쓰려면 Firestore 규칙을 다시 게시해야 합니다.** `hands`라는 컬렉션이 새로 추가되었으니, Firebase 콘솔 > Firestore Database > 규칙 탭에서 이 저장소의 `firestore.rules` 내용을 다시 붙여넣고 **게시**를 눌러 주세요. 규칙을 갱신하지 않으면 손들기 버튼을 눌러도 저장되지 않습니다.
